# Copilot Instructions for GitHub Actions Security Sandbox
Static analysis and attack simulation for GitHub Actions workflows. Detects injection vectors, supply chain risks, excessive permissions and secret exposure, then generates prioritized findings with remediation guidance.
## Code style
